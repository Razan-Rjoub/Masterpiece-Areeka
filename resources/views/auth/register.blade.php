...
<head>
    ...
    <style>
        ...
        * {
        ...
        .overlay {
            background: #FFC713;
            background: -webkit-linear-gradient(to right, #ffd342, #ffc400);
            background: linear-gradient(to right, #f4bb00, #ffcf31);
    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-up-container">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <input type="text" name="name" :value="old('name')"  autofocus autocomplete="username"
                    id="name" class="form-control form-control-lg" placeholder="Enter a your name" />
                ...
                <input type="email" name="email" :value="old('email')"  autofocus autocomplete="username"
                    id="email" class="form-control form-control-lg" placeholder="Enter a valid email address" />
