...
<div class="row gy-4">
  ...
  <div class="col-xl-8 order-xl-1 order-2">
    <div class="card">
      <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
           @foreach ($order_item as $order_item)  <tr>
    ...
    <td class="text-primary">{{ $order_item->id }}</td>
              ...
              <td>
                <div class="d-flex align-items-center">
                  <div class="avatar avatar-sm me-3">
                    <img src="{{asset($order_item->user->image)}}" alt="Avatar" class="rounded-circle">
                  </div>
                  <div>
              ...
              <td class="text-truncate">{{ $order_item->totalprice }}</td>
