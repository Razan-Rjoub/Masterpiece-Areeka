...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        if($role=='provider'){
            ...
            $order = Order::with(['payment','user'])->get();
            return view('Provider.orders.orderlist', compact('orderitem'));
    ...
    {   if(Auth::id()){
        ...
        return view('Admin.orders.orderdetail',compact('orderitem'));}
        if($role=='provider'){
        $order = Order::find($id);
    ...
    public function orderdetails($id)
    {
        ...
        return view('Provider.orders.orderdetail',compact('orderitem'));
    }
